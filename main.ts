...
export default class DafYomi extends Plugin {
	...
	async onload() {
	    ...
	    this.tractates = {
			...
			"2023-11-04": {startDate: this.makeDate("2023-11-04"), disp: "Bava Kamma", linkName: "Bava Kamma", prakim: [17,27,36,46,55,62,83,93,111], stpdf:"", stc:"", myjl: "bava-kamma-", sf:"Bava_Kamma.", dydg: "BavaKamma%20", hd: "bava-kamma-", lgg: "bava-kamma-"},
